This is Code Question. See below and attached images for explanation of the task.
It's not final, matter of fact, some test on Hacker Rank don't run.
Definetly needs to be optimized.
